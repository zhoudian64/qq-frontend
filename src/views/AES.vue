...
<script lang="ts">
    ...
    export default class RSA extends Vue {
        ...
        private async encryptPost() {
            ...
            const response = await this.axios.post("http://dom.gtmdcm.com:3000/api/aes_encrypt_text", data);
        ...
        private async decryptPost() {
            ...
            const response = await this.axios.post("http://dom.gtmdcm.com:3000/api/aes_decrypt_text", data);
